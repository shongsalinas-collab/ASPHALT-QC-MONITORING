...
function loadSpecsForm(){
  ...
  ['Grading 310-B','Grading 310-C','Grading 310-D','Grading 310-E','SMA - A','SMA - B','ATB - Asphalt Treated Basecoarse'].forEach(function(mat){
    var id = 'jmf-' + mat.replace(/ /g,'_').replace(///g,'_').replace(/-/g,'_');
    sv(id, jmf[mat]||'');
  });
}
function saveSpecs(){
  SPECS={
    ...
    ,jmfTargets:(function(){ var j={}; ['Grading 310-B','Grading 310-C','Grading 310-D','Grading 310-E','SMA - A','SMA - B','ATB - Asphalt Treated Basecoarse'].forEach(function(mat){ var id='jmf-'+mat.replace(/ /g,'_').replace(///g,'_').replace(/-/g,'_'); j[mat]=gv(id)||''; }); return j; })()
  };
